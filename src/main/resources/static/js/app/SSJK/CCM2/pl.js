define(['echarts', 'require'], function (ec, require) {
    var app = require('../../app');
    app.controller('plController2', function ($scope, $location) {
        // $scope.list = [];
        // $scope.totalItems = 0;
        // $scope.currentPage = 1;
        // var $ctrl = this;
        ...
        if (typeof (WebSocket) == "undefined") {
            ...
            socket.onmessage = function (msg) {
                ...
                //str 数组9-16是结晶器电磁搅拌运行频率
                var pl_1 = parseFloat(str[9]);
                var pl_2 = parseFloat(str[10]);
                var pl_3 = parseFloat(str[11]);
                var pl_4 = parseFloat(str[12]);
                var pl_5 = parseFloat(str[13]);
                var pl_6 = parseFloat(str[14]);
                var pl_7 = parseFloat(str[15]);
                var pl_8 = parseFloat(str[16]);
                ...
                var data_pl_7 = $scope.option8.series[0].data;

                if (data_pl_0.length < 6) {//图标展示60个点
                    ...
                    data_pl_7.push(pl_8);//在数组最后加入数据 （y轴）
