define(['echarts', 'require'], function (ec, require) {
    var app = require('../../app');
    app.controller('zkgylController1', function ($scope, $location) {
        // $scope.list = [];
        // $scope.totalItems = 0;
        // $scope.currentPage = 1;
        // var $ctrl = this;
        ...
        if (typeof (WebSocket) == "undefined") {
            ...
            socket.onmessage = function (msg) {
                ...
                var zkgyl_1 = parseFloat(str[1]);
                var zkgyl_2 = parseFloat(str[2]);
                var zkgyl_3 = parseFloat(str[3]);
                var zkgyl_4 = parseFloat(str[4]);


                var data_zkgyl_0 = $scope.option1.series[0].data;
                var data_zkgyl_1 = $scope.option2.series[0].data;
                var data_zkgyl_2 = $scope.option3.series[0].data;
                var data_zkgyl_3 = $scope.option4.series[0].data;

                if (data_zkgyl_0.length < 8) {//图标展示60个点
                    ...
                    data_zkgyl_0.push(zkgyl_1);//在数组最后加入数据 （y轴）
                    data_zkgyl_1.push(zkgyl_2);
                    data_zkgyl_2.push(zkgyl_3);
                    data_zkgyl_3.push(zkgyl_4);
                } else {
                    //data0.shift();//移除数组的第一项 （y轴）
                    //data0.push(num);//在数组最后加入数据 （y轴）
                    //option.xAxis[0].data.shift(); //移除数组的第一项 （x轴）
                    //option.xAxis[0].data.push(axisData); //在数组后添加一项（x轴）
                    data_zkgyl_0.shift();//移除数组的第一项 （y轴）
                    data_zkgyl_1.shift();//移除数组的第一项 （y轴）
                    data_zkgyl_2.shift();//移除数组的第一项 （y轴）
                    data_zkgyl_3.shift();//移除数组的第一项 （y轴）
                    data_zkgyl_0.push(zkgyl_1);//在数组最后加入数据 （y轴）
                    data_zkgyl_1.push(zkgyl_2);//在数组最后加入数据 （y轴）
                    data_zkgyl_2.push(zkgyl_3);//在数组最后加入数据 （y轴）
                    data_zkgyl_3.push(zkgyl_4);//在数组最后加入数据 （y轴）
