define(['echarts', 'require'], function (ec, require) {
    var app = require('../../app');
    app.controller('zkhlController1', function ($scope, $location) {
        // $scope.list = [];
        // $scope.totalItems = 0;
        // $scope.currentPage = 1;
        // var $ctrl = this;
        ...
        if (typeof (WebSocket) == "undefined") {
            ...
            socket.onmessage = function (msg) {
                ...
                var zkhl1 = parseFloat(str[5]);
                var zkhl2 = parseFloat(str[6]);
                var zkhl3 = parseFloat(str[7]);
                var zkhl4 = parseFloat(str[8]);


                var data_zkhl0 = $scope.option1.series[0].data;
                var data_zkhl1 = $scope.option2.series[0].data;
                var data_zkhl2 = $scope.option3.series[0].data;
                var data_zkhl3 = $scope.option4.series[0].data;

                if (data_zkhl0.length < 8) {//图标展示60个点
                    ...
                    data_zkhl0.push(zkhl1);//在数组最后加入数据 （y轴）
                    data_zkhl1.push(zkhl2);
                    data_zkhl2.push(zkhl3);
                    data_zkhl3.push(zkhl4);
                } else {
                    //data0.shift();//移除数组的第一项 （y轴）
                    //data0.push(num);//在数组最后加入数据 （y轴）
                    //option.xAxis[0].data.shift(); //移除数组的第一项 （x轴）
                    //option.xAxis[0].data.push(axisData); //在数组后添加一项（x轴）
                    data_zkhl0.shift();//移除数组的第一项 （y轴）
                    data_zkhl1.shift();//移除数组的第一项 （y轴）
                    data_zkhl2.shift();//移除数组的第一项 （y轴）
                    data_zkhl3.shift();//移除数组的第一项 （y轴）
                    data_zkhl0.push(zkhl1);//在数组最后加入数据 （y轴）
                    data_zkhl1.push(zkhl2);//在数组最后加入数据 （y轴）
                    data_zkhl2.push(zkhl3);//在数组最后加入数据 （y轴）
                    data_zkhl3.push(zkhl4);//在数组最后加入数据 （y轴）
