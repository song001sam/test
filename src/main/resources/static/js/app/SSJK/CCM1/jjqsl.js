define(['echarts', 'require'], function (ec, require) {
    var app = require('../../app');
    app.controller('jjqslController1', function ($scope, $location) {
        // $scope.list = [];
        // $scope.totalItems = 0;
        // $scope.currentPage = 1;
        // var $ctrl = this;
        ...
        var ws = "ws://" + host + ":" + port + "/BDIA/ws/ccm1_3";
        ...
        if (typeof (WebSocket) == "undefined") {
            ...
            //socket = new WebSocket("ws://localhost:8080/BDIA/ws/ccm1_3");
            ...
            socket.onmessage = function (msg) {
                ...
                //str 数组8-14是结晶器水量
                var jjqsl_1 = parseFloat(str[8]);
                var jjqsl_2 = parseFloat(str[9]);
                var jjqsl_3 = parseFloat(str[10]);
                var jjqsl_4 = parseFloat(str[11]);
                var jjqsl_5 = parseFloat(str[12]);
                var jjqsl_6 = parseFloat(str[13]);
                var jjqsl_7 = parseFloat(str[14]);
