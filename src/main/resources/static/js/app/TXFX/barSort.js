define(['echarts',
    ...
    app.controller('barSortController', function ($scope, $http, $uibModal) {
        ...
        $scope.echartsshow = function () {
            ...
            $http({
                ...
                angular.forEach($scope.data, function (item, n) {
                    xyData.push([item.xAxis, item.yAxis]);
                });
                ...
                xyData.sort(descend);
                angular.forEach(xyData, function (item, n) {
                    $scope.xAxisList.push(item[0]);
                    $scope.yAxisList.push(item[1]);
                });
                console.info(xyData);
                if (!$scope.echarts1) {
